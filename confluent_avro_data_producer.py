#Real-Time Data Pipeline: Kafka to MongoDB for E-Commerce - Producer Code
...
kafka_config = {
    ...
    'sasl.username': 'EFW3FXQ5GO2RBNCK',  # api key  of api section
    'sasl.password': 'rt5e8RZo74XNMWfrV7GVmoceJgta1HQV7hEx6I8hP4VN5GSPVBhSWyBf80hZDXG3'   # secret key of api section
}

# Create a Schema Registry client
schema_registry_client = SchemaRegistryClient({
  'url': 'https://psrc-777rw.asia-south2.gcp.confluent.cloud',
  'basic.auth.user.info': '{}:{}'.format('VDEVIF4AW6RKQWG7', 'gWvn0nih6ZRseW45UrjS6G7Rb+F6dZDUkIrAJWe+pnpSfVzyca3PUD3amOeA2VJ1')
})
